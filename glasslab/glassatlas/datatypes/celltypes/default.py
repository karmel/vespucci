...
SCHEMA_BASE = 'glass_atlas_{0}_{1}'.format(current_settings.GENOME, current_settings.CELL_TYPE.lower())
...
class GlassTranscriptDefault(GlassTranscript):
    ...
    class Meta(object):
        ...
        verbose_name = 'Unfiltered Glass transcript ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Unfiltered Glass transcripts ({0})'.format(current_settings.CELL_TYPE)
...
class GlassTranscriptPrepDefault(GlassTranscriptPrep):
    ...
    class Meta(object):
        ...
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Preparatory Glass transcript ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Preparatory Glass transcripts ({0})'.format(current_settings.CELL_TYPE)
...
class FilteredGlassTranscriptDefault(GlassTranscriptDefault, FilteredGlassTranscript):
    ...
    class Meta(object):
        proxy = True
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Glass transcript ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Glass transcripts ({0})'.format(current_settings.CELL_TYPE)
...
class GlassTranscriptSourcePrepDefault(GlassTranscriptSourcePrep):
    ...
    class Meta(object):
        ...
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Preparatory Glass transcript source ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Preparatory Glass transcript sources ({0})'.format(current_settings.CELL_TYPE)
...
class GlassTranscriptSourceDefault(GlassTranscriptSource):
    ...
    class Meta(object):
        ...
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Glass transcript source ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Glass transcript sources ({0})'.format(current_settings.CELL_TYPE)
...
class GlassTranscriptSequenceDefault(GlassTranscriptSequence):
    ...
    class Meta(object): 
        ...
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Glass transcript sequence region ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Glass transcript sequence regions ({0})'.format(current_settings.CELL_TYPE)
...
class GlassTranscriptNonCodingDefault(GlassTranscriptNonCoding):
    ...
    class Meta(object): 
        ...
        app_label = 'Transcription_{0}'.format(current_settings.CELL_TYPE)
        verbose_name = 'Glass transcript non-coding region ({0})'.format(current_settings.CELL_TYPE)
        verbose_name_plural = 'Glass transcript non-coding regions ({0})'.format(current_settings.CELL_TYPE)
