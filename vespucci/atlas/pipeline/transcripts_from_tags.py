...
if __name__ == '__main__':
    ...
    if options.tag_table:
        AtlasTag._meta.db_table = options.schema_name and '%s"."%s' % (options.schema_name, options.tag_table) \
    ...
    if options.stitch:
        ...
        cell_base.atlas_transcript.set_density(allow_extended_gaps=allow_extended_gaps,
                                               extension_percent=options.extension_percent)
