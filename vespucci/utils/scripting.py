...
class VespucciOptionParser(OptionParser):
    ...
    def set_cell(self, options):
        ...
        cell_type = (options.cell_type and options.cell_type.lower()) \
            or current_settings.CELL_TYPE.lower()
    ...
    def set_genome(self, options):
        ...
        for m in (datatypes.Chromosome,
                  datatypes.SequenceIdentifier,
                  datatypes.SequenceTranscriptionRegion,
                  datatypes.NonCodingRna,
                  datatypes.NonCodingTranscriptionRegion,
