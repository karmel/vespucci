...
from glasslab.dataanalysis.mlnumpy.base import BaseClassifier, MLSetup
...
if __name__ == '__main__':
    ...
    label_field = 'dex_4h_fc'
    labels = map(lambda x: int(x <= -1.4), data[:,fields.index(label_field)].tolist())
    ...
    ordered_indices = classifier.order_features()
