...
CREATE INDEX glass_transcribed_rna_glass_transcript_idx ON "glass_atlas_%s"."glass_transcribed_rna" USING btree (glass_transcript_id);
CREATE INDEX glass_transcribed_rna_chr_idx ON "glass_atlas_%s"."glass_transcribed_rna" USING btree (chromosome_id);
CREATE INDEX glass_transcribed_rna_strand_idx ON "glass_atlas_%s"."glass_transcribed_rna" USING btree (strand);
CREATE INDEX glass_transcribed_rna_start_end_idx ON "glass_atlas_%s"."glass_transcribed_rna" USING gist (start_end);

CREATE TABLE "glass_atlas_%s"."glass_transcribed_rna_source" (
    "id" int4 NOT NULL,
...
GRANT ALL ON TABLE "glass_atlas_%s"."glass_transcribed_rna_source" TO  "glass";
CREATE SEQUENCE "glass_atlas_%s"."glass_transcribed_rna_source_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE "glass_atlas_%s"."glass_transcribed_rna_source_id_seq" OWNED BY "glass_atlas_%s"."glass_transcribed_rna_source".id;
ALTER TABLE "glass_atlas_%s"."glass_transcribed_rna_source" ALTER COLUMN id SET DEFAULT nextval('"glass_atlas_%s"."glass_transcribed_rna_source_id_seq"'::regclass);
