...
CREATE INDEX glass_transcript_1_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_1" USING gist (start_end_density);
CREATE INDEX glass_transcript_1_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_1" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_2_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_2" USING gist (start_end_density);
CREATE INDEX glass_transcript_2_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_2" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_3_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_3" USING gist (start_end_density);
CREATE INDEX glass_transcript_3_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_3" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_4_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_4" USING gist (start_end_density);
CREATE INDEX glass_transcript_4_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_4" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_5_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_5" USING gist (start_end_density);
CREATE INDEX glass_transcript_5_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_5" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_6_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_6" USING gist (start_end_density);
CREATE INDEX glass_transcript_6_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_6" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_7_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_7" USING gist (start_end_density);
CREATE INDEX glass_transcript_7_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_7" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_8_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_8" USING gist (start_end_density);
CREATE INDEX glass_transcript_8_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_8" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_9_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_9" USING gist (start_end_density);
CREATE INDEX glass_transcript_9_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_9" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_10_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_10" USING gist (start_end_density);
CREATE INDEX glass_transcript_10_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_10" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_11_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_11" USING gist (start_end_density);
CREATE INDEX glass_transcript_11_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_11" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_12_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_12" USING gist (start_end_density);
CREATE INDEX glass_transcript_12_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_12" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_13_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_13" USING gist (start_end_density);
CREATE INDEX glass_transcript_13_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_13" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_14_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_14" USING gist (start_end_density);
CREATE INDEX glass_transcript_14_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_14" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_15_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_15" USING gist (start_end_density);
CREATE INDEX glass_transcript_15_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_15" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_16_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_16" USING gist (start_end_density);
CREATE INDEX glass_transcript_16_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_16" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_17_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_17" USING gist (start_end_density);
CREATE INDEX glass_transcript_17_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_17" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_18_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_18" USING gist (start_end_density);
CREATE INDEX glass_transcript_18_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_18" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_19_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_19" USING gist (start_end_density);
CREATE INDEX glass_transcript_19_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_19" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_20_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_20" USING gist (start_end_density);
CREATE INDEX glass_transcript_20_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_20" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_21_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_21" USING gist (start_end_density);
CREATE INDEX glass_transcript_21_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_21" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_22_start_end_density_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_22" USING gist (start_end_density);
CREATE INDEX glass_transcript_22_start_end_wide_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_22" USING gist (box(point(transcription_start - 2000, 0), point(transcription_end + 2000, 0)));
...
CREATE INDEX glass_transcript_source_transcript_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_source" USING btree (glass_transcript_id);
CREATE INDEX glass_transcript_source_sequencing_run_idx ON "glass_atlas_%s_%s_staging"."glass_transcript_source" USING btree (sequencing_run_id);
