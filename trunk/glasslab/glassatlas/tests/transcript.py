...
class TranscriptTestCase(GlassTestCase):
    ...
    def test_disparate_sequences(self):
        # Two transcripts that do not have the same sequence associations don't stitch.
        self.create_tag_table(sequencing_run_name='sample_run_1', sequencing_run_type='Gro-Seq')
        start, end = 3803150, 3803175
        GlassTag.objects.create(strand=0,
                                chromosome_id=5,
                                start=start, end=end,
                                start_end=(start, end)
    ...
    def test_disparate_ncrna(self):
        # Two transcripts that overlap with different ncrna don't stitch
        self.create_tag_table(sequencing_run_name='sample_run_1', sequencing_run_type='Gro-Seq')
        start, end = 90937130, 90937200
        GlassTag.objects.create(strand=0,
                                chromosome_id=2,
                                start=start, end=end,
                                start_end=(start, end)
        ...
        self.create_tag_table(sequencing_run_name='sample_run_2', sequencing_run_type='Gro-Seq')
        start_2, end_2 = 90936970, 90937120
        GlassTag.objects.create(strand=0,
                                chromosome_id=2,
                                start=start_2, end=end_2,
                                start_end=(start_2, end_2)
    ...
    ##################################################
    # Joining subtranscripts
    ##################################################
    def test_subtranscript_by_region(self): 
        # One transcript has two refseq sequences, one has one of the two. Is subsumed.
        self.create_tag_table(sequencing_run_name='sample_run_1', sequencing_run_type='Gro-Seq')
        start, end = 157340050, 157345000
        GlassTag.objects.create(strand=1,
                                chromosome_id=20,
                                start=start, end=end,
                                start_end=(start, end)
        ...
        self.create_tag_table(sequencing_run_name='sample_run_2', sequencing_run_type='Gro-Seq')
        start_2, end_2 = 157344995, 157346000
        GlassTag.objects.create(strand=1,
                                chromosome_id=20,
                                start=start_2, end=end_2,
                                start_end=(start_2, end_2)
    ...
    def test_subtranscript_not_overlapping(self): 
        # One transcript has two refseq sequences, one has one of the two, but they don't overlap. Not subsumed.
        self.create_tag_table(sequencing_run_name='sample_run_1', sequencing_run_type='Gro-Seq')
        start, end = 120239200, 120239500
        GlassTag.objects.create(strand=1,
                                chromosome_id=11,
                                start=start, end=end,
                                start_end=(start, end)
        ...
        self.create_tag_table(sequencing_run_name='sample_run_2', sequencing_run_type='Gro-Seq')
        start_2, end_2 = 120239510, 120245000
        GlassTag.objects.create(strand=1,
                                chromosome_id=11,
                                start=start_2, end=end_2,
                                start_end=(start_2, end_2)
    ...
    def test_subtranscript_disparate_regions(self): 
        # The transcripts share one region, but each has an xtra, unshared region as well. Not subsumed.
        self.create_tag_table(sequencing_run_name='sample_run_1', sequencing_run_type='Gro-Seq')
        start, end = 120340000, 120349000
        GlassTag.objects.create(strand=0,
                                chromosome_id=11,
                                start=start, end=end,
                                start_end=(start, end)
        ...
        self.create_tag_table(sequencing_run_name='sample_run_2', sequencing_run_type='Gro-Seq')
        start_2, end_2 = 120348900, 120360000
        GlassTag.objects.create(strand=0,
                                chromosome_id=11,
                                start=start_2, end=end_2,
                                start_end=(start_2, end_2)
